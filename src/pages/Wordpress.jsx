    ...
    <>
        ...
        <div className="relative w-full h-96 lg:h-screen">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
            <h1 className="text-3xl md:text-4xl font-bold text-center mb-4">
              WordPress<span className="text-red-600"> Development</span>
            </h1>
            <p className="text-md lg:p-0 p-2 md:text-lg mb-6 text-center max-w-lg">
              Custom WordPress development, tailored themes, plugin integrations, and optimized performance to create stunning, user-friendly, and scalable websites.
            </p>
            <Link to="/contact-us">
              <button
        ...
        <div className="w-full h-[80%] bg-[#ffffff] overflow-hidden mt-4">
          <div className="flex flex-col items-center justify-center h-full px-10 secondary-font">
            ...
            <p
              ...
              className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
            >
              With ongoing support and maintenance, we’re here to ensure your WordPress website stays up-to-date and continues to grow with your business. Let us help you bring your vision to life with a website that reflects your brand and engages your audience.

              This gives a comprehensive overview of your WordPress development services while staying within the word count range. Feel free to adjust it!
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
          ...
          >
            <img className="w-full ml-2" src="https://images.pexels.com/photos/3584969/pexels-photo-3584969.jpeg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            ...
            >
              ...
              <div className="w-full">
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  The first step in creating a successful WordPress website is understanding your business goals and audience. During this phase, we work closely with you to identify the key features your website needs, such as contact forms, e-commerce capabilities, or a blog section.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full">
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  We also assess your competitors and target market to ensure your website stands out. With a clear strategy in place, we create a roadmap to guide the project from start to finish, ensuring it aligns with your objectives and delivers the best user experience possible.
                </p>
              </div>
            </div>
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
          ...
          >
            <img className="w-full " src="https://img.freepik.com/free-psd/tattoo-landing-page-template-design_23-2150221694.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
          <div
            ...
            className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-4"
          >
            <img className="w-full " src="https://img.freepik.com/free-vector/user-interface-development-isometric-concept-with-young-woman-creating-custom-design-mobile-application-vector-illustration_1284-72341.jpg?ga=GA1.1.1263125129.1740053895&semt=ais_hybrid" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
          <div
            ...
            className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-0"
          >
            <img className="w-full ml-2" src="https://img.freepik.com/free-vector/handling-order-processing-illustration_335657-517.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
          <div
            ...
            className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-4"
          >
            <img className="w-full " src="https://img.freepik.com/free-vector/seo-concept-illustration_114360-5766.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
