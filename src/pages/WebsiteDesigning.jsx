...
const WebsiteDesigning = () => {
  ...
  <video
    ...
    playsInline
  >
    <source src="https://videos.pexels.com/video-files/4352274/4352274-sd_640_360_25fps.mp4" type="video/mp4" />
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
    ...
    Website<span className="text-red-600"> Designing</span>
    </h1>
  ...
  From stunning visuals to intuitive user interfaces, our goal is to ensure your website not only looks amazing but also drives results. Whether you need a simple landing page or a fully functional e-commerce site, we’re here to bring your vision to life and help your business thrive online. Let us create a website that leaves a lasting impression.
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
          ...
          >
            <img className="w-full ml-2" src="https://images.pexels.com/photos/221185/pexels-photo-221185.jpeg" alt="img" />
          </div>
  ...
  <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
    ...
    <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
      ...
      >
        <div className="w-full">
          <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
          A cohesive design with consistent colors, fonts, and elements across the site.
          </p>
        </div>
      </div>
      ...
      <p
        ...
        className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
      >
       Proper spacing between elements to prevent clutter and enhance readability.
   ...
   <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
       ...
       <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
         <div
           ...
           className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-0"
         >
           <img className="w-full ml-2" src="https://img.freepik.com/free-vector/gradient-ssl-illustration_23-2149247492.jpg" alt="img" />
         </div>
         <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
           <div data-aos="fade-left">
           <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
           ...
           >
         Security
        <span className="block mt-2 w-2/12 border-b-4 border-red-600"></span>
         </h1>
           ...
           >
             ...
             <div className="w-full">
               ...
               <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
               Protect your users’ data with secure Socket Layer encryption, building trust. Regular backups ensure your data is safe.
               </p>
             </div>
           </div>
  ...
  <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
    ...
    <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
      ...
      >
        <div className="w-full">
          <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
          Tools like Google Analytics help monitor performance and improve your website.
          </p>
        </div>
      </div>
       ...
       <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
        ...
        <span className="block mt-2 w-4/12 border-b-4 border-red-600"></span>
           ...
           <p
             ...
             className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
           >
          We continuously monitor and improve your website’s performance to ensure fast loading times, seamless user experiences, and high efficiency, even as traffic grows.
           </p>
           <div className="flex flex-col justify-center sm:flex-row items-center mb-12 lg:mb-0 lg:flex-row gap-10 mt-10">
           <button
             className="bg-red-600 text-white py-3 px-5 rounded-xl text-md transition-all duration-300 transform hover:bg-red-800 hover:scale-105 hover:shadow-lg"
