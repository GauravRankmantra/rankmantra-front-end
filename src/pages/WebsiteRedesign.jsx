...
const WebsiteRedesign = () => {
  ...
  <video
    ...
    playsInline
  >
    <source src="https://videos.pexels.com/video-files/29458457/12680991_640_360_25fps.mp4" type="video/mp4" />
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
    ...
    Website<span className="text-red-600"> Re-Designing</span>
    </h1>
    <p className="text-md lg:p-0 p-2 md:text-lg mb-6 text-center max-w-lg">
    Website Redesign page that focuses on the benefits of redesigning a website and the positive impact it can have on a business.
    </p>
    <Link to="/contact-us">
    <button
...
<div className="w-full h-[80%] bg-[#ffffff] overflow-hidden mt-4">
  <div className="flex flex-col items-center justify-center h-full px-10 secondary-font">
    ...
    >
      <div className="w-full">
        ...
        Is your website feeling outdated, slow, or failing to capture the attention of your audience. We specialize in website redesign services that refresh your online presence and drive results. Whether you need a complete overhaul or a simple update, our team is here to help you create a site that aligns with your business goals and resonates with your customers.
        </p>
      </div>
    </div>
    ...
    >
      <div className="w-full">
        <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
        A website redesign is more than just a facelift; it’s an opportunity to improve user experience (UX), enhance mobile responsiveness, and optimize your site’s performance. We focus on designing visually appealing, easy-to-navigate websites that look great across all devices—whether mobile, tablet, or desktop. We also integrate SEO optimization to help your site rank higher in search engines and attract more organic traffic.
        </p>
      </div>
    </div>
    ...
    >
 Our process is built around your needs. We begin with a thorough discovery phase to understand your business goals and user expectations. From there, we create a modern, functional design that reflects your brand while ensuring seamless usability. After launching, we continuously monitor and make improvements to ensure your website delivers long-term success.
    </p>
  </div>
</div>
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
          ...
          >
            <img className="w-full ml-2" src="https://images.pexels.com/photos/3888149/pexels-photo-3888149.jpeg" alt="img" />
          </div>
         ...
         <span className="block mt-2 w-4/12 border-b-4 border-red-600"></span>
            ...
            >
              ...
              Improve User Experience (UX):
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                Clear, intuitive menus and search options make it easy for users to find what they need.
                </p>
              </div>
            </div>
            ...
            >
              ...
              Increase Conversions:
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                Your website will adapt seamlessly to all devices—smartphones, tablets, and desktops. Fast-loading pages to retain visitors and improve overall performance.
                </p>
              </div>
            ...
            <p
              ...
              className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
            >
            We ensure your site is accessible to all, including those with disabilities, using screen readers, and high-contrast text.
  ...
  <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
    ...
    >
      <img className="w-full " src="https://images.pexels.com/photos/16129703/pexels-photo-16129703/free-photo-of-man-coding-on-computers-sitting-at-desk.jpeg" alt="img" />
    </div>
    <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
      <div data-aos="fade-left">
        <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
      ...
      >
        ...
        Discovery Phase:
          ...
          <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
          We begin by understanding your goals, challenges, and vision for your website.
          </p>
        </div>
      </div>
      ...
      >
        ...
        Design & Development:
          ...
          <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
          Our expert design team will create wireframes and mockups that align with your brand. We focus on user-centric design that’s visually appealing and optimized for performance.
          </p>
        </div>
      </div>
      <h2 className="text-[#7A6960] text-xl font-medium">
      ...
      <p
        ...
        className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
      >
        We help optimize your website’s content, ensuring it’s engaging, SEO-friendly, and effectively communicates your message.
      ...
      <p
        ...
        className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
      >
       After launch, we monitor website performance, making sure everything is running smoothly.
