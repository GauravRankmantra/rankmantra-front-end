...
const Socialpackage = () => {
  ...
  <div className="relative w-full h-96 lg:h-screen">
    <img
      src="https://images.pexels.com/photos/6956301/pexels-photo-6956301.jpeg" 
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
      <h1 className="text-4xl md:text-6xl font-bold text-center mb-4">
       SMM <span className="text-red-600">Packages</span>
      </h1>
  ...
  >
    <div>
      <Card
        ...
        price="$150/month"
        headings={["Time Period – 6 Months", "3 postings per week (per network)", "Social Account Setup", "Business Page Optimization", "Social Media Strategy (Overview)","Content Creation", "Increase in followers", "Account Management", "Monthly Progress Report"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$300/month"
        headings={["Time Period – 6 Months", "5 postings per week (per network)", "Social Account Setup", "Business Page Optimization", "Social Media Strategy (Overview)", "Content Creation", "Increase in followers", "Account Management", "Social Media Competitor Analysis", "Spam / Comments Monitoring", "Monthly Progress Report"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="Get a Quote"
        headings={["The custom social media packages can include any of the features of Silver and Gold packages as well as paid social media advertising.", "Click the button below to get in touch with us and we will design a social media strategy to help you get the results you want."]}
      />
    </div>
  </div>
</div>
