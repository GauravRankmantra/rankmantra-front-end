...
const Seopackage = () => {
  ...
  <div className="relative w-full h-96 lg:h-screen">
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
      ...
      SEO <span className="text-red-600">Packages</span>
      </h1>
  ...
  <div className="container mx-auto px-8 relative z-10">
    <div className="flex flex-wrap justify-center text-center lg:mb-[-20px] mb-6">
      <div className="w-full lg:w-6/12 px-4">
        <h2 className="lg:text-3xl text-2xl font-semibold uppercase" style={{ color: "#7a6960" }}>
          SEO PACKAGES WITH PROVEN RESULTS
    ...
    <div className="flex flex-wrap">
      <div className="flex min-h-screen items-center justify-center">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 lg:w-[85%]">
          ...
          <div className="group relative cursor-pointer flex flex-col items-center justify-center transition-shadow hover:shadow-xl hover:shadow-black/30 p-6 bg-white rounded-lg shadow-lg">
            <div className="mb-4 flex justify-center">
              ...
              <SiTicktick  className="lg:text-8xl text-6xl text-neutral-900" />
            </div>
            <h1 className="font-dmserif lg:text-xl text-md font-semibold" style={{ color: "#7a6960" }}>
            FROM ONLY $99 A MONTH
            </h1>
            <p className="mb-3 text-md text-gray-600 opacity-100">
            Get started for a low affordable small business price.
            </p>
          </div>
          ...
          <div className="group relative cursor-pointer flex flex-col items-center justify-center transition-shadow hover:shadow-xl hover:shadow-black/30 p-6 mt-6 lg:mt-0 bg-white rounded-lg shadow-lg">
            <div className="mb-4 flex justify-center">
              ...
              <MdOutlineCancel className="lg:text-8xl text-6xl text-neutral-900" />
            </div>
            <h1 className="font-dmserif lg:text-xl text-md font-semibold" style={{ color: "#7a6960" }}>
            NO CONTRACT - CANCEL ANYTIME
            </h1>
            <p className="mb-3 text-md text-gray-600 opacity-100">
            No long contracts, cancel whenever you want.
            </p>
          </div>
          ...
          <div className="group relative cursor-pointer flex flex-col items-center justify-center transition-shadow hover:shadow-xl hover:shadow-black/30 p-6 mt-6 lg:mt-0 bg-white rounded-lg shadow-lg">
            <div className="mb-4 flex justify-center">
              ...
              <TbReport className="lg:text-8xl text-6xl text-neutral-900" />
            </div>
            <h1 className="font-dmserif lg:text-xl text-md font-semibold" style={{ color: "#7a6960" }}>
            WEEKLY REPORTS
            </h1>
            <p className="mb-3 text-md text-gray-600 opacity-100">
            Weekly reports sent right to your email so your never left in the dark!
            </p>
          </div>
          <div className="group relative cursor-pointer flex flex-col items-center justify-center transition-shadow hover:shadow-xl hover:shadow-black/30 p-6 mt-6 lg:mt-0 bg-white rounded-lg shadow-lg">
            <div className="mb-4 flex justify-center">
              
              <BiSupport className="lg:text-8xl text-6xl text-neutral-900" />
            </div>
            <h1 className="font-dmserif lg:text-xl text-md font-semibold" style={{ color: "#7a6960" }}>
            PROFESSIONAL SUPPORT
            </h1>
            <p className="mb-3 text-md text-gray-600 opacity-100">
            We don’t OUTSOURCE! All work is handled by a team of marketing experts.
            </p>
          </div>
...
<div className="text-[#7A6960] w-full py-16 lg:px-10 overflow-hidden bg-[#FEFAF8] border-b border-orange-100">
  ...
  >
    <div>
      <Card
        ...
        price="$149/month"
        headings={["Perfect for Starters", "5 Local Keywords", "Website Optimization", "Search Engine Submission", "Weekly Reports"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$199/month"
        headings={["Medium Competition", "10 Keywords", "Perfect for Small Businesses", "Social Media Shares", "Dedicated Support"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$349/month"
        headings={["High Competition", "20 Keywords", "Advanced Optimization", "Perfect for Professionals", "Phone Support"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$599/month"
        headings={["High Competition", "40 Keywords", "Advanced Optimization", "Perfect for Ecommerce", "Dedicated Support"]}
      />
    </div>
  </div>
</div>
