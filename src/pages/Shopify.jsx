...
const Shopify = () => {
  ...
  return (
    <>
      ...
      <img
            src="https://images.pexels.com/photos/17485351/pexels-photo-17485351/free-photo-of-dlonie-wpisujace-tekst-na-klawiaturze-laptopa-z-otwartym-panelem-sklepu-internetowego-shoper.jpeg"
            className="absolute inset-0 w-full lg:h-[100%] h-full object-cover"
          />
          <div className="absolute inset-0 bg-black lg:h-[100%] opacity-30 z-0"></div>
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
    ...
    Shopify<span className="text-red-600"> Development</span>
    </h1>
...
<div className="w-full h-[80%] bg-[#ffffff] overflow-hidden mt-4">
 ...
 Our goal is to create a robust, scalable, and secure e-commerce platform that drives sales and enhances customer satisfaction. From inventory management to mobile responsiveness, we handle every detail to ensure your Shopify store performs at its best.
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
       ...
       <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
         ...
         >
           <img className="w-full ml-2" src="https://images.pexels.com/photos/17485353/pexels-photo-17485353/free-photo-of-laptop-z-otwartym-panelem-sklepu-internetowego-shoper.jpeg" alt="img" />
         </div>
        ...
        <span className="block mt-2 w-4/12 border-b-4 border-red-600"></span>
           ...
           >
             ...
             <div className="w-full">
               ...
               <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
               We start by designing a unique, responsive theme tailored to your brand’s aesthetic, ensuring it looks great on both desktop and mobile.
               </p>
             </div>
           </div>
 ...
 <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
   ...
   >
     <img className="w-full " src="https://images.pexels.com/photos/8284731/pexels-photo-8284731.jpeg" alt="img" />
   </div>
   <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
     <div data-aos="fade-left">
       <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
     ...
     >
       <div className="w-full">
         <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
         We help organize your products with clear categorization, high-quality images, and detailed descriptions to ensure an easy shopping experience for customers.
         </p>
       </div>
     </div>
     ...
     >
       <div className="w-full">
         <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
         Important elements like headlines and calls-to-action (CTAs) will grab attention.
         </p>
       </div>
     </div>
  ...
  <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
        <div
          ...
          className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-0"
        >
          <img className="w-full ml-2" src="https://images.pexels.com/photos/4565769/pexels-photo-4565769.jpeg" alt="img" />
        </div>
        <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
          <div data-aos="fade-left">
          <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
       ...
       <span className="block mt-2 w-4/12 border-b-4 border-red-600"></span>
          ...
          >
            ...
            <div className="w-full">
              ...
              <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
              We integrate essential apps that enhance functionality—such as email marketing tools, SEO optimizations, and payment gateways—to maximize sales potential.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="w-full">
              ...
              <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
              We implement measures to protect against hacking and other vulnerabilities.
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-center sm:flex-row items-center mb-12 lg:mb-0 lg:flex-row gap-10 mt-10">
...
<div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
 <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
   <div
     ...
     className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-4"
   >
     <img className="w-full " src="https://images.pexels.com/photos/7191166/pexels-photo-7191166.jpeg" alt="img" />
   </div>
   <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
     <div data-aos="fade-left">
       <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
     ...
     >
       <div className="w-full">
         <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
         Secure payment gateways and smooth checkout processes are integrated for a hassle-free shopping experience, building trust with your customers.
         </p>
       </div>
     </div>
     ...
     >
       <div className="w-full">
         <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
         We test different page versions to ensure the best user experience and conversion rates.
         </p>
       </div>
     </div>
...
<div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
        <div
          ...
          className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-0"
        >
          <img className="w-full ml-2" src="https://images.pexels.com/photos/8015682/pexels-photo-8015682.jpeg" alt="img" />
        </div>
        <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
          <div data-aos="fade-left">
          <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
       ...
       <span className="block mt-2 w-4/12 border-b-4 border-red-600"></span>
          ...
          >
            ...
            <div className="w-full">
              ...
              <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
              We offer ongoing support for maintenance, updates, and future enhancements to keep your store running smoothly.
          ...
          >
            ...
            <div className="w-full">
              ...
              <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
              We constantly monitor for issues, ensuring a smooth and error-free experience for your visitors.
              </p>
            </div>
          </div>
