...
const Onlinereputaion = () => {
  ...
  <div className="relative w-full h-96 lg:h-screen">
    <img
      src="https://images.pexels.com/photos/6483616/pexels-photo-6483616.jpeg" 
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
      ...
      ORM <span className="text-red-600">Packages</span>
      </h1>
...
<div className="text-[#7A6960] w-full py-16 lg:px-10 overflow-hidden bg-[#FEFAF8] border-b border-orange-100">
  ...
  Online Reputation Management (ORM) Pricing
  </h1>
  ...
  >
    <div>
      <Card
        title={"ORM PACKAGE FEATURES"}
       
        price="Monthly Costing"
        headings={["Phrases Protected & Monitored", "Search Positions Protected", "Search Positions Monitored", "Article Marketing", "Link Building Services", "Search Engine Optimization","Blogging Services","Campaign Duration","Reporting"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$380/month"
        headings={["1-2", "1st Page", "1-10", "5","50", "YES", "5","6 Month", "Monthly"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$680/month"
        headings={["3-5", "1st Page", "1-10", "10","100", "YES", "10","6 Month", "Fornight"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$980/month"
        headings={["6-8", "1-2Page", "1-20", "25","300", "YES", "25","6 Month", "Weekly"]}
      />
    </div>
...
export default Onlinereputaion;
