...
const Payperclick = () => {
  ...
  <div className="relative w-full h-96 lg:h-screen">
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
      ...
      PPC <span className="text-red-600">Packages</span>
      </h1>
...
<div className="text-[#7A6960] w-full py-16 lg:px-10 overflow-hidden bg-[#FEFAF8] border-b border-orange-100">
  ...
  PAY PER CLICK- Affordable PPC Packages
  </h1>
  ...
  >
    <div>
      <Card
        ...
        price="Monthly"
        headings={["Strategy Development & Analysis", "5Keyword Research", "Landing Page Creation", "Keyword Target", "Adowrds Campaign Setup & Management", "Google Analytic Setup & Tracking","Weekly Reporting"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$250/month"
        headings={["YES", "YES", "YES", "20","YES", "YES", "YES"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$350/month"
        headings={["YES", "YES", "YES", "30","YES", "YES", "YES"]}
      />
    </div>
    ...
    <div>
      <Card
        ...
        price="$500/month"
        headings={["YES", "YES", "YES", "50","YES", "YES", "YES"]}
      />
    </div>
    <div>
      <Card
        ...
        price="Monthly"
        headings={["Strategy Development & Analysis", "Facebook Page Creation & Promotion", "Audience Targeting", "Ads Creation & Optimization", "Pixel Setup", "Google Analytic Setup", "Weekly Reporting"]}
      />
    </div>
    <div>
      <Card
        ...
        price="$150/month"
        headings={["YES", "YES", "YES", "5","YES", "YES", "YES"]}
      />
    </div>
    <div>
      <Card
        ...
        price="$200/month"
        headings={["YES", "YES", "YES", "8","YES", "YES", "YES"]}
      />
    </div>
    <div>
      <Card
        ...
        price="$250/month"
        headings={["YES", "YES", "YES", "10","YES", "YES", "YES"]}
      />
    </div>
  </div>
</div>
