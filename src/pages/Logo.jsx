...
const Logo = () => {
    ...
    const bgStyle = {
        backgroundImage: `url("https://images.pexels.com/photos/2480854/pexels-photo-2480854.jpeg")`,
  ...
  return (
    <>
      ...
      <section className="w-full max-h-fit py-12 lg:px-30 overflow-hidden border-b border-orange-100 relative ">
      ...
      >
        ...
        >
          <div className="text-center space-y-4 lg:max-w-[430px] mx-auto">
            <h1 className="text-3xl font-bold !leading-snug text-red-600">
              400+ Logo design are Done by using the Canva, Looka, Asobeillustrator and AdobePhotoshop.
            </h1>
