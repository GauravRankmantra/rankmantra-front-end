    ...
    <>
      ...
      <section className="w-full max-h-fit py-10 lg:px-30 overflow-hidden border-b border-orange-100 relative ">
        <div className="relative w-full h-96 lg:h-screen">
          <video
            ...
            playsInline
          >
            <source src="https://videos.pexels.com/video-files/7966582/7966582-sd_640_360_25fps.mp4" type="video/mp4" />
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
          ...
          >
            <img className="w-full ml-2" src="https://img.freepik.com/free-vector/business-planning-with-calendar_23-2149164011.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            ...
            >
              ...
              <div className="w-full">
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  It’s time to make the move from paper calendar to a web-based schedule.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full">
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  Now, schedule and create and stick to-do-list which will be easy to use.
                </p>
              </div>
            </div>
            ...
            <p
              ...
              className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
            >
              A content calendar is a great way to plan and organize your content well in advance. It helps you to maintain a consistent content production schedule and other assets to tell your brand story, drive SEO and win sales.
            </p>
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
          ...
          >
            <img className="w-full " src="https://img.freepik.com/free-vector/flat-design-content-management-system_23-2148808086.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
            ...
            >
              <div className="w-full">
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  With limited resources and time, creating a unique post for each social media channel can be a challenging, but it is well worth the effort.
                </p>
              </div>
            </div>
            ...
            >
              <div className="w-full">
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  Under these conditions, specialized content management systems have developed into central technologies.
                </p>
              </div>
            </div>
            ...
            <p
              ...
              className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
            >
              Expand your reach on social media sites by getting more likes on your posts. Create compelling, unique and insightful content that people want to know.
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 secondary-font">
          <div
            ...
            className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-0"
          >
            <img className="w-full ml-2" src="https://img.freepik.com/free-vector/seo-analytics-team-concept-illustration_114360-9205.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
            ...
            >
              ...
              <div className="w-full">
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  Let your face to be seen everywhere across several platforms. We conduct keyword research and know how to use it.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full">
                ...
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  SEO begins with keyword research and so we develop content to target the best keyword.
                </p>
              </div>
            </div>
            ...
            <p
              ...
              className="text-md lg:text-lg mt-5 text-gray-600 primary-font"
            >
              We also distribute content through various marketing channels which will quickly turn customers inward.
            </p>
            <div className="flex flex-col justify-center sm:flex-row items-center mb-12 lg:mb-0 lg:flex-row gap-10 mt-10">
              <button
                className="bg-red-600 text-white py-3 px-5 rounded-xl text-md transition-all duration-300 transform hover:bg-red-800 hover:scale-105 hover:shadow-lg"
      ...
      <div className="w-full lg:px-4 overflow-hidden bg-[#ffffff] border-b border-orange-100">
        <div className="flex flex-col lg:flex-row-reverse items-center lg:gap-10 secondary-font">
          <div
            ...
            className="lg:w-1/2 w-full md:w-3/4 py-16 px-10 md:px-4"
          >
            <img className="w-full " src="https://img.freepik.com/premium-photo/male-asian-graphic-designer-working-office-studio-using-laptop-designing-logos-showcasing-corporate-identity-logo-design-process_126277-2826.jpg" alt="img" />
          </div>
          <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
            <div data-aos="fade-left">
              <h1 className="lg:text-4xl text-2xl text-black primary-font font-semibold"
            ...
            >
              <div className="w-full">
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  Use post planner to find, plan and post better content to boost your reach and social media marketing.
                </p>
              </div>
            </div>
            ...
            >
              <div className="w-full">
                <p className="text-md lg:text-lg text-gray-600 primary-font lg:mt-1 mt-2">
                  Plan and bring clarity to your chaos and also eliminate guess work with a custom plan.
                </p>
              </div>
            </div>
