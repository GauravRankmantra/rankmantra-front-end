...
const Card = ({ title, price, headings }) => {
  ...
  <FaFacebook className="text-4xl lg:mr-10 hover:text-blue-600 transition-all duration-300" />
  <FaTwitter className="text-4xl lg:mr-10 hover:text-blue-400 transition-all duration-300" />
  <FaInstagram className="text-4xl lg:mr-10 hover:text-pink-500 transition-all duration-300" />
  <FaLinkedin className="text-4xl lg:mr-10 hover:text-blue-700 transition-all duration-300" />
</div>
        ...
        <div className="mt-5 space-y-2">
          {headings && headings.map((heading, index) => (
            <div key={index} className="lg:text-md text-md text-gray-600">{heading}</div>
          ))}
        </div>
