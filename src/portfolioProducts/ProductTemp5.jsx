            ...
            <div className="shadow-xl border-2 p-8">
              ...
              <ul className="mt-3">
                ...
                <li>
                  ...
                  <a href="https://mahandmeofficial.com/" target="_blank" class="text-orange-600">https://mahandmeofficial.com/</a>
                </li>
              </ul>
            </div>
            <div>
